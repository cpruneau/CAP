...
RandomGenerator::RandomGenerator(TRandom * rg)
: randomGenerator(rg)
{}
...
ScalarDoubleRandomGenerator::ScalarDoubleRandomGenerator(double min, double max, TRandom * rg) :
  RandomGenerator(rg),
  minimum (min),
  maximum (max),
  range   (max-min)
...
ClassImp(LinearScalarDoubleRandomGenerator);
  ...
  LinearScalarDoubleRandomGenerator::LinearScalarDoubleRandomGenerator(double minimum,double maximum, TRandom * randomGenerator)
  :
...
VectorRandomGenerator::VectorRandomGenerator(TRandom * rg)
  :
  RandomGenerator(rg)
  {
  }
