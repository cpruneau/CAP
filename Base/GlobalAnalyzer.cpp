...
{
  if (reportStart("GlobalAnalyzer",getName(),"setDefaultConfiguration()"))
    {
    }
...
{
  if (reportStart("GlobalAnalyzer",getName(),"initialize()"))
    ;
  Task::initialize();
  ...
  if (reportDebug("GlobalAnalyzer",getName(),"initialize()"))
    {
