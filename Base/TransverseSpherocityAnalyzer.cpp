...
{
  if (reportStart("TransverseSpherocityAnalyzer",getName(),"setDefaultConfiguration()"))
    {
    }
  ...
  if (reportDebug("TransverseSpherocityAnalyzer",getName(),"setDefaultConfiguration()"))
    {
...
{
  if (reportStart("TransverseSpherocityAnalyzer",getName(),"initialize()"))
    ;
  Task::initialize();
  ...
  if (reportDebug("TransverseSpherocityAnalyzer",getName(),"initialize()"))
    {
...
{
  if (reportStart("TransverseSpherocityAnalyzer",getName(),"createHistograms()"))
    ;
  ...
  if (reportEnd("TransverseSpherocityAnalyzer",getName(),"createHistograms()"))
    ;
}

void TransverseSpherocityAnalyzer::loadHistograms(TFile * inputFile)
{
  if (reportStart("TransverseSpherocityAnalyzer",getName(),"loadHistograms(TFile * inputFile)"))
    ;
  Configuration & configuration = getConfiguration();
  TString prefixName = getName(); prefixName += "_";
  unsigned int nEventFilters    = eventFilters.size();;
  ...
  if (reportEnd("TransverseSpherocityAnalyzer",getName(),"loadHistograms(TFile * inputFile)"))
    ;
}

void TransverseSpherocityAnalyzer::execute()
{
  //  if (reportDebug("TransverseSpherocityAnalyzer",getName(),"execute()"))
  //    {
  //    }
