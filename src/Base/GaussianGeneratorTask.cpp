...
virtual void GaussianGeneratorTask::initialize()
{
  if (reportStart("GaussianGeneratorTask",getName(),"initialize()"))
    ;
  Configuration & configuration = getConfiguration();
  amplitude = configuration.getValueDouble("amplitude");
  gammaeta  = configuration.getValueDouble("gammaeta");
  gammaphi  = configuration.getValueDouble("gammaphi");
  omegaeta  = configuration.getValueDouble("omegaeta");
  omegaphi  = configuration.getValueDouble("omegaphi");
  ...
  if (reportEnd("GaussianGeneratorTask",getName(),"initialize()"))
    ;
}
