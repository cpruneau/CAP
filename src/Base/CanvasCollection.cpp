...
// Create a canvas
// =================================================
TCanvas * CanvasCollection::createCanvas(const TString & canvasName, const CanvasConfiguration & configuration, int inc)
{
...
// Create a canvas
////////////////////////////////////////////////////
TCanvas * CanvasCollection::createCanvasXX(int nx, int ny, const TString & canvasName, const CanvasConfiguration & configuration, int inc)
{
  int xInc = inc*getCollectionSize();
  TCanvas * canvas = new TCanvas(canvasName,
                                 canvasName,
