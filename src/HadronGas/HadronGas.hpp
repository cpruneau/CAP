...
public:
  ...
  vector<double> chemicalPotentials;
  vector<double> particleDensities;
  vector<double> particleEnergies;
  vector<double> particleEntropies;
  vector<double> particlePressures;
  vector<double> particleDsDmu;
  vector<double> particleDnDmu;
  vector<double> particleDeOverTDmu;
  vector<double> particleDpOverTmu;

  vector<double> deltaN_bulk_term1s;
  vector<double> deltaN_bulk_term2s;
  vector<double> deltaN_qmu_term1s;
  vector<double> deltaN_qmu_term2s;
  ...
  vector< vector<double> > decayProbabilities;
  vector< vector< vector<double> > > decayPairProbabilities;
