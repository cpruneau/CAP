...
double ParticleThermalProperties::hbarC     = 0.19733;
double ParticleThermalProperties::hbarC2    = ParticleThermalProperties::hbarC * ParticleThermalProperties::hbarC;
double ParticleThermalProperties::hbarC3    = ParticleThermalProperties::hbarC2 * ParticleThermalProperties::hbarC;
double ParticleThermalProperties::hbarC4    = ParticleThermalProperties::hbarC3 * ParticleThermalProperties::hbarC;

double ParticleThermalProperties::pi        = TMath::Pi();
double ParticleThermalProperties::piSquare  = ParticleThermalProperties::pi * ParticleThermalProperties::pi;
double ParticleThermalProperties::piCube    = ParticleThermalProperties::piSquare * ParticleThermalProperties::pi;
...
ParticleThermalProperties::ParticleThermalProperties(const ParticleType * _type)
{
...
void ParticleThermalProperties::calculateAllProperties(double _temp, double _muB, double _muS)
{
  ...
  numberDensity     = numberDensity*spinFactor*mass2*temperature/(2*piSquare*hbarC3);
  ...
  energyDensity     = energyDensity*spinFactor*mass4/(2*piSquare*hbarC3);
  pressure          = pressure*spinFactor*mass2*temperature*temperature/(2*piSquare*hbarC3);
  entropyDensity    = (energyDensity + pressure - mu*numberDensity)*beta;    // unit : 1/fm^3
  dPoverTdmu        = dPoverTdmu*spinFactor*mass2/(2*piSquare*hbarC3);
  deoverTdmu        = deoverTdmu*spinFactor*mass4/(2*piSquare*hbarC3);
  dndmu             = dndmu*spinFactor*mass/(2*piSquare);
...
{
  cout << setw(size) << setchar('.') << name << " : " << value << setchar(' ') << endl;
}
