...
int RunAnalysis()
{
  ...
  if (runPythiaGenerator)
    ...
    //pythiaConfig.addParameter("dataOutputFileName", TString("Pythia_pp_7000.root") );
    //pythiaConfig.addParameter("dataOutputTreeName", TString("PythiaTree") ) ;
    //pythiaConfig.addParameter("dataOutputPath",outputPathName);
    pythiaConfig.addParameter("dataInputUsed",    NO);
    //pythiaConfig.addParameter("dataInputFileName",TString("Pythia_pp_13000_10Mevents.root") );
    //pythiaConfig.addParameter("dataInputTreeName",TString("PythiaTree") );
    //pythiaConfig.addParameter("dataInputPath",    TString(getenv("WAC_INPUT_DATA_PATH")));
