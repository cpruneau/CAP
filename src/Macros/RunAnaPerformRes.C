...
int RunAnaPerformRes()
{
  ...
  TString inputPathBase   = "/Volumes/ClaudeDisc4/OutputFiles/PythiaFlatEffRes/";
  TString outputPathBase  = "/Volumes/ClaudeDisc4/OutputFiles/PythiaFlatEffRes/";
  ...
  switch (analysisParticleFilterOption)
    {
      ...
      case 4:  analysisParticleFilters = ParticleFilter::createChargedHadronFilters(YES,0.2, 2.0, YES,-2.0, 2.0, NO, 10.0, -10.0); break;
...
//      performConfig.addParameter(baseName+"_PhiRmsA2",   0.0);
      ...
      performConfig.addParameter(baseName+"_EffPeakPt",0.001);
      performConfig.addParameter(baseName+"_EffPeakRms",0.005);
