            ...
            int  plotIntegralVsLogY=1)
{
  ...
  if (histosDeltaYProjB12s.size()>0 && plot1D)
    ...
    if (plot1DType==1)
      ...
      cout << " ------------------------------------------------------------"  << endl;
      cout << " ------------------------------------------------------------"  << endl;
      cout << " Sum of integrals has n:" << integralGraphsB12s.size() << endl;
...
int PlotBFBaryons(int option = 1)
{
  bool printGif = 0;
  bool printPdf = 1;
  bool printSvg = 0;
...
//  int  plot1D=0;
  ...
  TString inputPath  = "/Volumes/ClaudeDisc4/OutputFiles/PYTHIA/PP/13000/Baryons/";
  ...
  switch (option)
    {
      case 0:
      {
      TString inFileName = "PairGenBalFctSum0TO7.root";
...
//      speciesNames.push_back(TString("Pbar"));
//      speciesNames.push_back(TString("Nbar"));
//      speciesNames.push_back(TString("Lambda0bar"));
//      speciesNames.push_back(TString("SigmaPbar"));
//      speciesNames.push_back(TString("Sigma0bar"));
//      speciesNames.push_back(TString("SigmaMbar"));
//      speciesNames.push_back(TString("Xi0bar"));
//      speciesNames.push_back(TString("XiMbar"));
//      speciesNames.push_back(TString("OmegaMbar"));
      ...
      for (int iSpecies1=0; iSpecies1<9; iSpecies1++)
        {
        ...
        for (int iSpecies2=0; iSpecies2<9; iSpecies2++)
          {
      ...
      for (int iSpecies1=0; iSpecies1<speciesNames.size(); iSpecies1++)
        {
        TString outFileNameBase2 = outFileNameBase;
        outFileNameBase2 += (speciesNames[iSpecies1]);
        outFileNameBase2 += "_";
        ...
        for (int iSpecies2=0; iSpecies2<speciesNames.size(); iSpecies2++)
          {
