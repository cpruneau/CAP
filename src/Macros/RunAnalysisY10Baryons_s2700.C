...
int RunAnalysisY10Baryons_s2700()
{
  ...
  int     analysisParticleFilterOption   = 8;
  ...
  TString pathSuffix      = "Y10WidePt/Baryons/";
  ...
  switch (analysisParticleFilterOption)
    {
      ...
      case 5:  analysisParticleFilters = ParticleFilter::createPlusMinusHadronFilters(YES,0.0, 20.0, NO,-2.0, 2.0, YES,  -10.0, 10.0); break;
      ...
      case 8:  analysisParticleFilters = ParticleFilter::createBaryonFilters(YES,0.0, 20.0, NO,-2.0, 2.0, YES,  -10.0, 10.0); break;
    }
