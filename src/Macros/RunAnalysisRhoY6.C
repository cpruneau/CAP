...
int RunAnalysisRhoY6()
{
  ...
  long    nIterationRequested            = 100000;
...
//  int     targetPdgCode                  = 2212;
  ...
  TString pathSuffix      = "WideGenY6WidePt/";
  ...
  switch (analysisParticleFilterOption)
    {
      ...
      case 4:  analysisParticleFilters = ParticleFilter::createChargedHadronFilters(YES,0.000, 20.0, NO,-6.0, 6.0, YES, -6.0, 6.0); break;
  ...
  if (runGausResGenerator)
    ...
    resConfig.addParameter("yMinimum",            -6.0);
    resConfig.addParameter("yMaximum",             6.0);
