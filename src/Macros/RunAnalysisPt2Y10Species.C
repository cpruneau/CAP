...
int RunAnalysisPt2Y10Species_1000()
{
  ...
  TString pathSuffix      = "Y10Pt2/Species/";
  ...
  switch (analysisParticleFilterOption)
    {
      ...
      case 6:  analysisParticleFilters = ParticleFilter::createPlusMinusHadronFilters(YES,0.0, 2.0, NO,-2.0, 2.0, YES,  -10.0, 10.0); break;
