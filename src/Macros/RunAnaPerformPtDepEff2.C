...
int RunAnaPerformPtDepEff2()
{
  ...
  TString inputPathBase   = "/Volumes/ClaudeDisc4/OutputFiles/PythiaPtDepEff2/";
  TString outputPathBase  = "/Volumes/ClaudeDisc4/OutputFiles/PythiaPtDepEff2/";
...
//      performConfig.addParameter(baseName+"_PhiRmsA2",   0.0);
      ...
      performConfig.addParameter(baseName+"_EffPeakRms",0.3);
      performConfig.addParameter(baseName+"_EffA1",-0.05);
