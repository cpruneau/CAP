...
//! (histogrammed) with instances of the ParticlePair3DHistos class. The behavior of the class, i.e., what type and the range of filled histograms are determined by
